...
age_bracket_voted_2020 = female_rep_df.groupby('age_bracket')['voted_2020'].sum().reset_index()
...
# Calculate the percentage of Female REP voters who voted in 2020 relative to the total for each age bracket
...
fig = px.bar(
    ...
    x='age_bracket',
    y='Percentage',
    title='Female REP Voter Participation in 2020 by Age Group',
