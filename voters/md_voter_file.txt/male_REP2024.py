...
age_bracket_voted_2024 = male_rep_df.groupby('age_bracket')['voted_2024'].sum().reset_index()
...
# Calculate the percentage of Male REP voters who voted in 2024 relative to the total for each age bracket
...
fig = px.bar(
    ...
    x='age_bracket',
    y='Percentage',
    title='Male REP Voter Participation in 2024 by Age Group',
