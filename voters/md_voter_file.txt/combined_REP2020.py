...
female_age_bracket_voted_2020 = female_rep_df.groupby('age_bracket')['voted_2020'].sum().reset_index()
male_age_bracket_voted_2020 = male_rep_df.groupby('age_bracket')['voted_2020'].sum().reset_index()
...
fig = px.bar(
    ...
    y='Percentage',
    color='Gender',
    title='Combined Female and Male REP Voter Participation in 2020 by Age Group',
