...
age_bracket_voted_2024 = male_dem_df.groupby('age_bracket')['voted_2024'].sum().reset_index()
...
# Calculate the percentage of Male DEM voters who voted in 2024 relative to the total for each age bracket
...
fig = px.bar(
    ...
    x='age_bracket',
    y='Percentage',
    title='Male DEM Voter Participation in 2024 by Age Group',
